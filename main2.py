...
prompt = st.chat_input("user") #userinput
...
if prompt == 'hello':
	...
	st.chat_message("assistant").write('I am who I have always been')
	st.session_state.messages.append({'role': 'assistant', "content": "I am who I have always been"})
elif prompt == 'hi':
